...
import de.samply.qualityreportgenerator.context.CsvConfig;
...
public abstract class ScriptEngineImpl implements ScriptEngine {
  ...
  public ScriptResult generateRawResult(Script script, Context context)
    ...
    result.setRawResult(fetchResultPath(context));
    return result;
  }
  ...
  protected String fetchRandomFilename() {
    return FileUtils.fetchRandomFilename(QrgConst.DEFAULT_SCRIPT_RESULT_FILE_EXTENSION);
  }
