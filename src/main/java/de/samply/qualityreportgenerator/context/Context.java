...
import de.samply.qualityreportgenerator.script.CsvRecordIterator;
...
public class Context {
  ...
  private QualityReportTemplate qualityReportTemplate;
  ...
  public Context(Path resultsDirectory, QualityReportTemplate qualityReportTemplate,
      Path[] sourcePaths, CsvConfig csvConfig) {
    this.resultsDirectory = resultsDirectory;
    this.qualityReportTemplate = qualityReportTemplate;
  ...
  public QualityReportTemplate getQualityReportTemplate() {
